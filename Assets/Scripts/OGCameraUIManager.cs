...
public class OGCameraUIManager : MonoBehaviour
{
    public static OGCameraUIManager Instance;

    [Header("Scene Cameras")]
    public GameObject arRig; // contains ARCamera
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        // Debug logs
        if (arRig == null && scene.name == "MainARScene") Debug.LogWarning("ARRig not found!");
