...
namespace Mapbox.BaseModule.Data.Platform.TileJSON
{
	public class TileJSONResponse
	{
		...
		public double[] Bounds
		{
			...
			{
				_bounds = value;
				BoundsParsed = new LatitudeLongitudeBounds(
					new LatitudeLongitude(Bounds[1], Bounds[0])
					, new LatitudeLongitude(Bounds[3], Bounds[2])
				);
			}
		}
		
		[JsonIgnore]
		public LatitudeLongitudeBounds BoundsParsed { get; private set; }
		...
		public double[] Center
		{
			...
			{
				_center = value;
				CenterParsed = new Vector2d.Vector2d(_center[1], _center[0]);
			}
		}

		[JsonIgnore]
		public Vector2d.Vector2d CenterParsed { get; private set; }
