...
namespace Mapbox.BaseModule.Data.Tiles
{
	public sealed class TileResource : IResource
	{
		...
		public static TileResource MakeBuilding(CanonicalTileId id, string tilesetId)
		{
			return new TileResource(string.Format("https://api.tiles.mapbox.com/3dtiles/v1/{0}/{1}.glb", tilesetId, id));
		}
