...
namespace Mapbox.BaseModule.Data.Tiles
{
	...
	public class RawPngRasterTile : RasterTile
	{
		...
		public RawPngRasterTile(CanonicalTileId tileId, string tilesetId, bool useNonReadableTexture = false) : base(tileId, tilesetId, useNonReadableTexture)
		{
		}
	}
	...
	public class DemRasterTile : RawPngRasterTile
	{
		...
		public DemRasterTile(CanonicalTileId tileId, string tilesetId, bool useNonReadableTexture = false) : base(tileId, tilesetId, useNonReadableTexture)
		{
		}
	}
}
