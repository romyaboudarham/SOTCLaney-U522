...
namespace Mapbox.BaseModule.Utilities
{
	public static class VectorExtensions
	{
		...
		{
			t.position = Conversions.LatitudeLongitudeToWorldPosition(lat, lng, refPoint, scale);
		}
		...
		{
			return Conversions.LatitudeLongitudeToWorldPosition(latLon.x, latLon.y, refPoint, scale);
		}
		...
		/// </code>
		/// </example>
		public static LatitudeLongitude GetGeoPosition(this Transform t, Vector2d refPoint, float scale = 1)
		{
			var pos = refPoint + (t.position / scale).ToVector2d();
			return Conversions.WebMercatorToLatLon(pos);
		}

		public static LatitudeLongitude GetGeoPosition(this Vector3 position, Vector2d refPoint, float scale = 1)
		{
			var pos = refPoint + (position / scale).ToVector2d();
			return Conversions.WebMercatorToLatLon(pos);
		}

		public static LatitudeLongitude GetGeoPosition(this Vector2 position, Vector2d refPoint, float scale = 1)
		{
